...
http.createServer(function(req,res){
	if(req.url == "/form"){
		...
		fs.createReadStream("./form.html","UTF-8").pipe(res); //make sure you enter the correct path of the directory in which the drag and drop form is as the first argument of this function
